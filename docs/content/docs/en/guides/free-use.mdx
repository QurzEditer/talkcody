...
| **OpenCode Zen** | Free Models | Optimized for coding, provides free GLM-4.7 | Requires account registration |
...
OpenCode Zen provides free access to the GLM-4.7 model, a high-performance large language model specifically optimized for coding tasks. You can use it in TalkCody without paying additional fees.

### Configuration Steps

For detailed API Key configuration steps, please refer to the [OpenCode Zen API Key Configuration Guide](../configuration/api-keys#opencode-zen).

After configuration, you can select the GLM-4.7 model in TalkCody's **Model Settings** to use it for free.
