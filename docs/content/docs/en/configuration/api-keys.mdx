...
- **OpenCode Zen** - Curated models optimized for coding agents
...
OpenCode Zen is a curated list of AI models that have been tested and benchmarked by the OpenCode team specifically for coding agents. All models are verified to ensure consistent and high-quality performance in coding tasks.

**Steps to obtain:**
1. Visit [opencode.ai/zen](https://opencode.ai/zen)
2. Click "Get started with Zen" or "Login" to go to the registration page
3. Register an account and log in
4. Find the API Key in your account settings
5. Copy the generated API key
6. Paste it into TalkCody's OpenCode Zen field

<Callout type="tip">
OpenCode Zen offers a free GLM-4.7 model that can be used for free in TalkCody.
</Callout>
